...
def init_tool_selector_agent(config: LLMConfig) -> Agent:
    return Agent(
        name="Tool Selector Agent",
        description="A tool selector that can determine which specialized agents should address a knowledge gap",
        model=config.model,
