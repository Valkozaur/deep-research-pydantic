...
from src.agents.tool_agents.search_agent import init_search_agent
...
def init_planner_agent(LLMConfig: LLMConfig) -> Agent:
    web_search_agent = init_search_agent(LLMConfig)
    
    planner_agent = Agent(
        name="Report Planner Agent",
        model=LLMConfig.model,
        description="A research manager that can produce an initial outline of the report and some background context",
